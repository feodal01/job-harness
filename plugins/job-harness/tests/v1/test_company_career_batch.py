...
from job_harness.v1.company_career_batch import (
...
from job_harness.v1.company_career_search import CompanyVacancyHit
...
class CompanyCareerBatchTest(unittest.TestCase):
    ...
    def test_check_company_times_out_hanging_link_extraction(self) -> None:
        ...
        with patch("job_harness.v1.company_career_batch._find_matching_links_http", side_effect=RuntimeError("http failed")):
    ...
    def test_check_company_uses_http_fallback_after_browser_timeout(self) -> None:
        ...
        with patch("job_harness.v1.company_career_batch._find_matching_links_http", return_value=[hit]):
            record = asyncio.run(_check_company(_AsyncContext(page), company, ["qa"], timeout_ms=10))
    ...
    def test_check_company_uses_alternate_jobs_url_when_careers_url_missing(self) -> None:
        ...
        with patch("job_harness.v1.company_career_batch._find_matching_links_http", return_value=[hit]) as fallback:
    ...
    def test_linkedin_only_timeout_is_reported_as_access_issue(self) -> None:
        ...
        with patch(
            "job_harness.v1.company_career_batch._find_matching_links_http",
