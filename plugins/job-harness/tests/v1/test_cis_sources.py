...
from job_harness.v1.models import SearchParams
from job_harness.v1.scrapers.cis_sources import (
    FinderWorkScraper,
    GeekJobScraper,
    GetmatchScraper,
    HireHiScraper,
...
class CisSourcesTest(unittest.TestCase):
    ...
    def test_hirehi_search_filters_by_any_it_role_not_only_qa(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_text", return_value=HIREHI_HTML):
    ...
    def test_hirify_maps_api_response(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_json", return_value=HIRIFY_JSON):
    ...
    def test_hirify_reads_nested_company_and_marks_missing_company(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_json", return_value=payload):
            listings = scraper.search(SearchParams(query="QA", country="AM"))
    ...
    def test_staff_am_extracts_next_data_jobs_and_filters_by_query(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_text", return_value=STAFF_HTML) as fetch:
            listings = scraper.search(SearchParams(query="QA", country="AM"))
    ...
    def test_finder_work_maps_api_response(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_json", return_value=FINDER_JSON):
    ...
    def test_finder_work_search_url_uses_salary_from(self) -> None:
        scraper = FinderWorkScraper(context=None, max_results=5)
        with patch("job_harness.v1.scrapers.cis_sources.fetch_json", return_value={"items": []}) as fetch:
    ...
    def test_it_jobs_uz_maps_api_response(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_json", return_value=IT_JOBS_UZ_JSON) as fetch:
    ...
    def test_jobturbo_extracts_json_ld_item_list(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_text", return_value=JOBTURBO_HTML):
            listings = scraper.search(SearchParams(query="QA", country="RU"))
    ...
    def test_getmatch_uses_matching_specialization_and_maps_offer(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_json", side_effect=fake_fetch_json):
    ...
    def test_getmatch_matches_non_qa_it_specializations(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.cis_sources.fetch_json", return_value=GETMATCH_SPECIALIZATIONS):
