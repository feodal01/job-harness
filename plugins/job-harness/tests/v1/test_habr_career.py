...
from job_harness.v1.scrapers.habr_career import HabrCareerScraper
...
class HabrCareerScraperTest(unittest.TestCase):
    ...
    def test_fetch_html_retries_transient_timeouts(self) -> None:
        ...
        with patch("job_harness.v1.scrapers.habr_career.urlopen", side_effect=fake_urlopen) as urlopen:
