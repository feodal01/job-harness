...
class SourceCatalogTableTest(unittest.TestCase):
    def test_catalog_contains_the_supported_v2_source_rows(self) -> None:
        ...
        # Assert
        self.assertEqual(
            ("habr_career", "hh_ru", "talanto", "career:vk", "career:jetbrains"),
    ...
    def test_country_catalog_contains_supported_search_countries(self) -> None:
        ...
        # Assert
        self.assertEqual(("RU",), tuple(country.country_code for country in countries))
        self.assertTrue(countries[0].search_enabled)
