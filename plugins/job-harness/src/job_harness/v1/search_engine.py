...
import job_harness.v1.registry as registry
from job_harness.v1.experience_engine import parse_experience_levels
from job_harness.v1.http_runner import HttpRunner, SourceOutcome
from job_harness.v1.models import RawListing, RawSearchRecord, SearchParams, SearchResults
...
from job_harness.v1.source_runtime import (
...
class SearchEngine:
    ...
    async def _run_browser_source(
        ...
        from job_harness.v1.browser_pool import BlockedResult, PoolAcquireTimeout, PoolShutdown
        from job_harness.v1.types import BLOCK_REASON_TO_FAILURE_MODE
