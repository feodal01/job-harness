...
from job_harness.v1.models import JsonValue, RawListing, SearchParams
...
def _query_terms(query: str) -> list[str]:
    from job_harness.v1.company_career_search import _query_terms as impl

    return impl(query)


def _load_company_targets(**kwargs: Any) -> list[CompanyProfile]:
    from job_harness.v1.company_career_batch import _load_company_targets as impl
...
async def _check_company(
    ...
    from job_harness.v1.company_career_batch import _check_company as impl
