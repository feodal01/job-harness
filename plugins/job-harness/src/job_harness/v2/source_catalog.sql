...
VALUES
    ...
    ('career:vk', 5, 'remote_in_country', 'native_request'),
    ...
    ('career:amocrm', 5, 'remote_in_country', 'unsupported'),
    ('career:amocrm', 6, 'remote_global', 'unsupported'),
    ('career:amocrm', 7, 'countries', 'structured_output'),
